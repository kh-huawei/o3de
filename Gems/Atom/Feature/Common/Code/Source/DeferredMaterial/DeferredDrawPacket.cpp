...
namespace AZ
{
    namespace Render
    {
            ...
            const RPI::ShaderCollection::Item& shaderItem)
        {
            ...
            // the draw-packet can outlast the original material asset it was created for, so don't keep a reference to the asset
            ...
            m_requestedShaderVariantId = shaderOptions.GetShaderVariantId();
            ...
            if (!m_shader)
            {
                AZ_Error(
                    ...
                    m_instigatingMaterialAsset.GetHint().c_str());
                return;
            }
            ...
            const AZ::RPI::ShaderVariant& variant = m_shader->GetVariant(m_requestedShaderVariantId);
            ...
            m_activeShaderVariantId = variant.GetShaderVariantId();
            m_activeShaderVariantStableId = variant.GetStableId();
