...
namespace AZ
{
    namespace Render
    {
        ...
        public:
            ...
            //! Updates / Sets the materials for a mesh
            void UpdateMaterials(const ModelId& uuid, ModelDataInstanceInterface* meshHandle, const Data::Instance<RPI::Model>& model);
